...
namespace steemit {
  namespace protocol {
    ...
    fc::variant_object get_config ( ) {
      ...
      result["STEEMIT_ACCOUNT_RECOVERY_REQUEST_EXPIRATION_PERIOD"] =
      ...
      result["STEEMIT_CREATE_ACCOUNT_WITH_STEEM_MODIFIER"] =
      ...
      result["STEEMIT_FREE_TRANSACTIONS_WITH_NEW_ACCOUNT"] =
          STEEMIT_FREE_TRANSACTIONS_WITH_NEW_ACCOUNT;
   ...
   result["STEEMIT_INIT_PRIVATE_KEY"] = STEEMIT_INIT_PRIVATE_KEY;
      ...
      result["STEEMIT_ORIGINAL_MIN_ACCOUNT_CREATION_FEE"] =
          STEEMIT_ORIGINAL_MIN_ACCOUNT_CREATION_FEE;
      result["STEEMIT_OWNER_AUTH_HISTORY_TRACKING_START_BLOCK_NUM"] =
      ...
      result["STEEMIT_SBD_INTEREST_COMPOUND_INTERVAL_SEC"] =
      ...
      result["STEEMIT_VESTING_WITHDRAW_INTERVALS_PRE_HF_16"] =
          STEEMIT_VESTING_WITHDRAW_INTERVALS_PRE_HF_16;
      result["STEEMIT_VESTING_WITHDRAW_INTERVAL_SECONDS"] =
